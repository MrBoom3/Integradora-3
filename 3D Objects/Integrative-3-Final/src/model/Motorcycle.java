    ...
    public class Motorcycle extends Vehicle implements GasolineConsume {
        ...
        public Motorcycle(double base_price,String mark,int model, Double cilinderCapacity, int kilometers, VehicleType type, String licensePlate, Documents [] documents,MotorcycleType motoType, int tankCapacity){
