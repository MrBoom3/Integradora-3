...
public class Main{
        ...
        public void defaultVehicle(){
            ...
            String brand;
            System.out.println("Insert the brand of the vehicle:");
            brand=sc.nextLine();
...
//.
        ...
        public void makeReport(){
            ...
            int option;
            System.out.println("Make report acording to:" +"\n" +
            "1 Vehicle type \n" +
            "2 Fuel type \n" +
            "3 Used or new cars");
            option = sc.nextInt();
        ...
        public void documentsOfVehicle(){
            System.out.println("Insert ID of the vehicle:");
            int id = sc.nextInt();
        ...
        public void reportParking(){
            System.out.println("What criteria?\n 1 Range of years \n 2 Newest and oldest vehicle \n 3 Busy porcentage  ");
        ...
        public void reportRange(){
            ...
            System.out.println("Firt the young year:");
            int year1 = sc.nextInt();
            sc.nextLine();
            System.out.println("Second the older year:");
